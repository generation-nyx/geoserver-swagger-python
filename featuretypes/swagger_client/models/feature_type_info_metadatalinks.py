...
class FeatureTypeInfoMetadatalinks(object):
    ...
    """
    swagger_types = {
        'metadata_link': 'list[FeatureTypeInfoMetadatalinksMetadataLink]'
    }
    ...
    def __init__(self, metadata_link=None, _configuration=None):  # noqa: E501
        """FeatureTypeInfoMetadatalinks - a model defined in Swagger"""  # noqa: E501
    ...
    def metadata_link(self):
        """Gets the metadata_link of this FeatureTypeInfoMetadatalinks.  # noqa: E501

        A collection of metadata links for the resource.  # noqa: E501

        :return: The metadata_link of this FeatureTypeInfoMetadatalinks.  # noqa: E501
        :rtype: list[FeatureTypeInfoMetadatalinksMetadataLink]
        """
        return self._metadata_link

    @metadata_link.setter
    def metadata_link(self, metadata_link):
        """Sets the metadata_link of this FeatureTypeInfoMetadatalinks.

        A collection of metadata links for the resource.  # noqa: E501

        :param metadata_link: The metadata_link of this FeatureTypeInfoMetadatalinks.  # noqa: E501
        :type: list[FeatureTypeInfoMetadatalinksMetadataLink]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FeatureTypeInfoMetadatalinks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeatureTypeInfoMetadatalinks):
            return False
