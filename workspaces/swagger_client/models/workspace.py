...
class Workspace(object):
    ...
    def __init__(self, workspace=None, _configuration=None):  # noqa: E501
    ...
    @property
    def workspace(self):
        """Gets the workspace of this Workspace.  # noqa: E501


        :return: The workspace of this Workspace.  # noqa: E501
        :rtype: WorkspaceWorkspace
        """
        return self._workspace

    @workspace.setter
    def workspace(self, workspace):
        """Sets the workspace of this Workspace.


        :param workspace: The workspace of this Workspace.  # noqa: E501
        :type: WorkspaceWorkspace
        """
        if self._configuration.client_side_validation and workspace is None:
